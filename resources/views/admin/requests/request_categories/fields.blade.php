...
<div class="form-group {{$errors->has('status_id') ? 'has-error' : ''}} col-sm-6 col-sm-offset-3">
    ...
    {!! Form::select('status_id', $statuses, @$requestCategory->status_id, ['class' => 'form-control', 'placeholder' => tags()['general_select']]) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.requestCategories.index') !!}" class="btn btn-default">Cancel</a>
</div>
