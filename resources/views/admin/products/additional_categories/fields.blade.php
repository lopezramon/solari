...
<div class="form-group {{$errors->has('language_id') ? 'has-error' : ''}} col-sm-6 col-sm-offset-3">
    ...
    {!! Form::select('language_id', $languages, @$additionalCategory->additionalCategoryTranslations[0]->language_id, ['class' => 'form-control', 'placeholder' => tags()['general_select']]) !!}
...
<div class="form-group col-sm-6 col-sm-offset-3">
    ...
    <a href="{!! route('admin.additionalCategories.index') !!}" class="btn btn-default">Cancel</a>
</div>