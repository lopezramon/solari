...
<div class="form-group {{$errors->has('language_id') ? 'has-error' : ''}} col-sm-6 col-sm-offset-3">
    ...
    {!! Form::select('language_id', $languages, $productSubcategory->productSubcategoryTranslations[0]->language_id, ['class' => 'form-control', 'placeholder' => tags()['general_select']]) !!}
...
<div class="form-group col-sm-6 col-sm-offset-3">
    ...
    {!! Form::select('product_category_id', $productCategory, null, ['class' => 'form-control', 'placeholder' => tags()['general_select']]) !!}
