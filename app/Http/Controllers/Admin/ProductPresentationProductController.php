...
class ProductPresentationProductController extends AppBaseController
{
    ...
    {
        return view('admin.products.product_presentation_products.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.products.product_presentation_products.edit')->with('productPresentationProduct', $productPresentationProduct);
    }
