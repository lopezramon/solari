...
class ResetPasswordController extends Controller
{
    ...
    */
     ...
     */
     public function sendResetResponseFront($data_user,$response)
    {
        \Mail::to($data_user->email,$data_user->name)->send(new setPassword($data_user));
    ...
    public function resetFront(Request $request)
    {
       ...
       $this->validate($request, $this->rules(), $this->validationErrorMessages());
        ...
        return $response == Password::PASSWORD_RESET
                    ? $this->sendResetResponseFront($data_user,$response)
                    : $this->sendResetFailedResponseFront($request, $response);
    }
