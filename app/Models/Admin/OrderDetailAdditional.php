...
/**
 * Class OrderDetailAdditional
 * @package App\Models\Admin
 * @version August 28, 2018, 11:03 pm CEST
 *
 * @property \App\Models\Admin\Additional additional
 * @property \App\Models\Admin\OrderDetail orderDetail
 ...
 * @property integer additional_quantity
 */
class OrderDetailAdditional extends Model
{
    use SoftDeletes;

    public $table = 'order_details_additionals';
    ...
    {
        return $this->belongsTo(\App\Models\Admin\Additional::class);
    }
    ...
    {
        return $this->belongsTo(\App\Models\Admin\OrderDetail::class);
    }
}
