...
/**
 * Class ProductFeatureCategoryTranslation
 * @package App\Models\Admin
 * @version September 6, 2018, 9:03 pm CEST
 *
 * @property \App\Models\Admin\ProductFeatureCategory productFeatureCategory
 ...
 * @property integer product_feature_category_id
 * @property integer language_id
 * @property string name
 * @property string description
 */
class ProductFeatureCategoryTranslation extends Model
{
    use SoftDeletes;

    public $table = 'product_feature_category_translations';
