 ...
 * @property integer room_location_id
 * @property integer language_id
 * @property string name
 * @property string description
 */
class RoomLocationTranslation extends Model
{
    use SoftDeletes;

    public $table = 'room_location_translations';
