...
/**
 * Class RequestCategoryTranslation
 * @package App\Models\Admin
 * @version September 13, 2018, 5:57 pm CEST
 *
 * @property \App\Models\Admin\Language language
 * @property \App\Models\Admin\RequestCategory requestCategory
 ...
 */
class RequestCategoryTranslation extends Model
{
    use SoftDeletes;

    public $table = 'request_category_translations';
    ...
    {
        return $this->belongsTo(\App\Models\Admin\RequestCategory::class);
    }
}
