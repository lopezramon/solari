 ...
 * @property \Illuminate\Database\Eloquent\Collection ScreensFrontSection
...
class FrontSection extends Model
{
     ...
     **/
    public function screensFrontSections()
    {
        return $this->hasMany(\App\Models\Admin\ScreensFrontSection::class);
    }
